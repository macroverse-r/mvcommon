...
mv_h1("My first execution (should be level 1 - numbered 1.)")

A()

mv_h1("My first prints (should be level 1 - numbered 2.)")

mv_h2("Subsection 1 of 'My first prints' (should be level 2 - numbered 2.1.)")

mv_text("Hello World")

Sys.sleep(1)

mv_h2("Subsection 2 of 'My first prints' (should be level 2 - numbered 2.2.)")
